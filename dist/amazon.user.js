...
(function () {
  ...
  function getProductOverviewRowLabel(row) {
    ...
    return labelElement instanceof HTMLElement ? normalizeTextContent(labelElement.textContent) : "";
  }
  ...
  function getProductOverviewRowValueElement(row) {
    ...
    const valueCandidates = Array.from(valueCell.querySelectorAll(":scope > span, :scope > a, span, a")).filter((element) => element instanceof HTMLElement);
